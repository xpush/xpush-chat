...
console.log(' [ Daemon Process got started. ]');

console.log(' - TYPE : ' + envType);
console.log(' - PID : ' + envPid);
...
var afterProcess = function () {
  ...
  async.series([
    ...
    function (callback) {
      ...
      console.info('SERVER NAME on terminating : ' + serverName);
          ...
          redisClient.hgetall(CONS.XC_S + ':' + serverName, function (err, res) {
            ...
            if (err) {
              ...
              for (var _key in res) {
                ...
                redisClient.hdel(CONS.XC_U + ':' + sinfo[0] + ':' + sinfo[0], sinfo[0]);
